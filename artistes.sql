...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2022 at 12:31 PM
...
INSERT INTO `artistes` (`idArtist`, `name`, `idGenre`, `tour`, `description`, `id_picture`, `active`, `way_img`) VALUES
...
ALTER TABLE `artistes`
  ...
  ADD KEY `artistes_idGenre` (`idGenre`);
...
--
-- Constraints for table `artistes`
--
ALTER TABLE `artistes`
  ADD CONSTRAINT `artistes_idGenre` FOREIGN KEY (`idGenre`) REFERENCES `genre` (`idGenre`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
